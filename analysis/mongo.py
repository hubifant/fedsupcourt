...
count_language = lambda language: collection.find({'date': {'$lt': date_limit}, 'language': language}).count()

print('Keyword Counts: ')
print('Total Number of Rulings (before July 2016): %5d' % collection.find({'date': {'$lt': date_limit}}).count())
